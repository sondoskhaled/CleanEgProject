...
<?php
    ...
    //session_start();
  if(isset($_POST['btnForgetPassCitizen']))
  {
     $c=new Citizens();
      
     $c->setCitizenEmail($_POST['ForgetPassCitizenEmail']);   
     $c->setCitizenPhone($_POST['ForgetPassCitizenEmail']);   
      $us=$_POST['ForgetPassCitizenEmail'];
        ...
        if($rows=mysqli_fetch_assoc($r))
           {
           // $phone=$rows['Phone']  ;
            $email=$rows['CitizenEmail']  ;
            $name=$rows['CitizenName']  ;
          ...
          //  $type= $_POST['forget'];
               ...
               //echo !extension_loaded('openssl')?"Not Available":"Available";
                ...
                $mail->Subject = 'Forget Password Citizen';
                $mail->Body = 'visit this link http://localhost/CleanEgProjectn/updatePassCitizen.php?Citizen='.$us;
               ...
               <form method="post"  >
                ...
                <div class="form-group"> 
                       <div class="input-icon">
                           ...
                           <input type="email" name="ForgetPassCitizenEmail" 
                           value="<?php echo isset($_POST['ForgetPassCitizenEmail'])?$_POST['ForgetPassCitizenEmail']:'' ?>"
                           class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input"  placeholder="Email / Phone" required> 
                       </div>
                        
                   </div>

                  
                  <input type="submit" name="btnForgetPassCitizen" value="Send"  
