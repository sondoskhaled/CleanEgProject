...
<div class="container">
     <div class="row my-4 my-md-5">
           <div class="col-12 col-md-4 col-lg-3">
               ...
               <div class="rage-slider">
                    <h2 class="font-16 semi-font fables-forth-text-color fables-light-gary-background  p-3 mb-4">Filter by price</h2> 
                         ...
                         <div class="range-slider fables-forth-text-color" id="facet-price-range-slider" data-options='{"output":{"prefix":""},"maxSymbol":"+"}'>
                             <input name="range-1" id="r1" value="0" min="0" max="10000" step="1" type="range">
                             <input name="range-2" id="r2" value="10000" min="0" max="10000" step="1" type="range">
                         </div> 
                         <button  id="filter" class="btn btn-block fables-second-background-color rounded-0 white-color white-color-hover p-2 font-15 mb-4">Filter</button>
               ...
               <li><a href="AllProductsAfter.php" >All Category</a></li>
               <?php
                                        ...
                                        <li><a href="AllProductsAfter.php?CNo=<?php echo $row['CategoryNo'];?>" id='<?php echo $row['CategoryNo'];?>' ><?php echo $row['CategoryName'];?></a></li>
                                   <?php } ?>
               </ul>
                           ...
                           <form> 
                              <div class="form-group mb-0"> 
                                <select class="form-control rounded-0" id="sort">
                                  ...
                                  <option value="4">By Name Low To High</option>
                                </select>
                              </div> 
                            </form>
                       </div>
                           ...
                           <div class="card rounded-0 mb-4">
                               <div class="row">
                                   <div class="fables-product-img col-12">
                                      ...
                                      <div class="fables-img-overlay">                                          
                                          <ul class="nav fables-product-btns">
                                              <li><a href="ProductDetailsAfter.php?ProNo=<?php echo($row['ProductNo']); ?>&CatNo=<?php echo($row['CategoryNo']); ?>&CNo=<?php echo($row['ColorNo']); ?>" class="fables-product-btn"><span class="fables-iconeye"></span></a></li>
                                              <li><a  href="AddToFav.php?ProNo=<?php echo($row['ProductNo']); ?>&CNo=<?php echo($row['ColorNo']); ?>"  class="fables-product-btn"><span class="fables-iconheart"></span></a></li>
                                          </ul>
                                      </div>
                                  </div>
                                  <div class="card-body col-12">
                                    ...
                                    <p class="fables-product-info"><a href="AddToCart.php?PNo=<?php echo($row['ProductNo']); ?>&QYT=1&Color=<?php echo($row['ColorNo']); ?>&p=3" class="btn fables-second-border-color fables-second-text-color fables-btn-rouned fables-hover-btn-color font-14 p-2 px-2 px-xl-4">
                        ...
                        $("#filter").click(function() {
                            ...
                            $.ajax({
                                ...
                                P.forEach(function(Pro) {
                                    ...
                                    $('#pro').append(`<div class="col-12 col-sm-6 col-lg-4 fables-product-block">
                           <div class="card rounded-0 mb-4">
                               <div class="row">
                                   <div class="fables-product-img col-12">
                                      <img class="card-img-top rounded-0" src="assets/custom/images/products/${Pro.ProductNo}${Pro.ColorNo}.jpg" alt="dress fashion">
                                      <div class="fables-img-overlay">                                          
                                          <ul class="nav fables-product-btns">
                                              <li><a href="ProductDetailsBefore.php?ProNo=${Pro.ProductNo}&CatNo=${Pro.CategoryNo}&CNo=${Pro.ColorNo}" class="fables-product-btn"><span class="fables-iconeye"></span></a></li>
                                  ...
                                  <div class="card-body col-12">
                                    <h5 class="card-title mx-xl-3">
                                        <a href="#" class="fables-main-text-color fables-store-product-title fables-second-hover-color">${Pro.ProductName}</a>
                                    </h5>
                                    <p class="store-card-text fables-fifth-text-color font-15 mx-xl-3" title="${Pro.ProductDetails}">${Pro.ProductDetails}</p>
                                    <p class="font-15 font-weight-bold fables-second-text-color my-2 mx-xl-3">$ ${Pro.ProductPrice}</p>
