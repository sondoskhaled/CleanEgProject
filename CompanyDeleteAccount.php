...
if(isset($_POST['btnDeleteCompany']))
{
    $c=new Company();
    $c->setCompanyLicense($_GET['company']);   
...
<div class="fables-header fables-after-overlay">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Delete Account</h2>
    </div>
</div>  
<!-- /End Header -->
...
<div class="container">
     <div class="row my-4 my-lg-5">
          ...
          <img src="assets/custom/images/signin-logo.png" alt="signin" class="img-fluid">
               <p class="font-20 semi-font fables-main-text-color mt-4 mb-5">Are you sure ?</p>
         <!-- company register -->
        <form method="post" >
                
                   <input type="submit" name="btnDeleteCompany" value="Delete Account"  
