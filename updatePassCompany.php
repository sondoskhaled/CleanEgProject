...
if(isset($_POST['btnUpdateCompany']))
{
    ...
    $c->setCompanyPassword($_POST['CompanyUpdatePass']);
     $username= $_GET['Company'];
        $c->setCompanyEmail($username);   
          ...
          <div class="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-3 text-center">
               ...
               <div class="form-group"> 
                       <div class="input-icon">
                          ...
                          <input type="password" name="CompanyUpdatePass" minlength="5"  
                          value="<?php echo isset($_POST['CompanyUpdatePass'])?$_POST['CompanyUpdatePass']:'' ?>"
                  ...
                  <input type="submit" name="btnUpdateCompany" value="Update"  
