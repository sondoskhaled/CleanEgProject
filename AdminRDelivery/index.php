...
<body>    
            ...
            <div class="mb-5 mt-5 font-40 font-weight-bold text-center" style="height:50px;Padding-top:50px;">Pending Requests</div>
                            ...
                            <td><a href="#exampleModal<?php echo $rows['RequestNo']; ?>"  data-toggle="modal" data-target="#exampleModal<?php echo $rows['RequestNo']; ?>">Request Details</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="UpdateStatus.php?ONo=<?php echo $rows['RequestNo']; ?>"  class="btn btn-secondary">Shipping</a>
