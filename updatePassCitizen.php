...
//session_start();
if(isset($_POST['btnUpdateCitizen']))
{
    $c=new Citizens();
   
    $c->setCitizenPassword($_POST['citizenUpdatePass']);
     $username= $_GET['Citizen'];
        $c->setCitizenEmail($username);   
        $c->setCitizenPhone($username);   
...
<div class="container">
     <div class="row my-4 my-lg-5">
          <div class="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-3 text-center">
               ...
               <p class="font-20 semi-font fables-main-text-color mt-4 mb-5">Update Password</p>
               ...
               <div class="form-group"> 
                       <div class="input-icon">
                          ...
                          <input type="password" name="citizenUpdatePass" minlength="5"  
                          value="<?php echo isset($_POST['citizenUpdatePass'])?$_POST['citizenUpdatePass']:'' ?>"
                  ...
                  <input type="submit" name="btnUpdateCitizen" value="Update"  
