...
<div class="container"> 
     <div class="row my-4 my-md-5">
          ...
          <?php
                  ...
                  <div class="col-9 col-md-4 col-lg-5 mt-3 mt-sm-0 mr-auto ml-auto mr-md-0 ml-md-auto">
                      ...
                      <form  method="post">
                          ...
                          <span class="calc-width">
                              ...
                              <input type="text" id="input-val"  name="btn" class="form-control d-inline-block border text-center form-circle-input rounded-circle"> 
              ...
              <div class="row mb-5">
                  <div class="col-6">
                        <a id="a" class="btn fables-second-border-color fables-second-text-color fables-btn-rouned fables-hover-btn-color font-14 px-4 py-2 semi-font">
                  ...
                  <script>
                      $(document).ready(function(){
                          $("#a").on('click',function(){
                                v=$("#input-val").val();
                                window.location.href="AddToCart.php?PNo=<?php echo($_GET['ProNo']); ?>&QYT="+v+"&Color=<?php echo($_GET['CNo']); ?>&p=2";
                          });
                      });
                  </script>
                  <div class="col-6 text-right"> 
                        ...
                        <a href="AddToFav.php?ProNo=<?php echo($_GET['ProNo']); ?>&CNo=<?php echo($_GET['CNo']); ?>" class="btn text-white fables-product-btn fables-forth-background-color rounded-circle fables-second-hover-background-color p-0"><span class="fables-iconheart"></span></a>
                       ...
                       <div class="fables-product-img col-12">
                          ...
                          <div class="fables-img-overlay">                                          
                              <ul class="nav fables-product-btns">
                                  <li><a href="ProductDetailsAfter.php?ProNo=<?php echo($rs['ProductNo']); ?>&CatNo=<?php echo($rs['CategoryNo']); ?>&CNo=<?php echo($rs['ColorNo']); ?>" class="fables-product-btn"><span class="fables-iconeye"></span></a></li>
                                  <li><a href="AddToFav.php?ProNo=<?php echo($rs['ProductNo']); ?>&CNo=<?php echo($rs['ColorNo']); ?>"   class="fables-product-btn"><span class="fables-iconheart"></span></a></li>
                              </ul>
                          </div>
                      </div>
                      <div class="card-body col-12">
                        <h5 class="card-title mx-3">
                            <a href="#" class="fables-main-text-color font-16 semi-font fables-second-hover-color"><?php echo($rs['CategoryName']); ?></a>
                        </h5>
                        ...
                        <p class="fables-product-info">
                            <a href="AddToCart.php?PNo=<?php echo($rs['ProductNo']); ?>&QYT=1&Color=<?php echo($rs['ColorNo']); ?>&p=2"  class="btn fables-second-border-color fables-second-text-color fables-btn-rouned fables-hover-btn-color font-14 p-2 px-4">
                        <span class="fables-iconcart"></span> 
