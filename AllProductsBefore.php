...
<div class="container">
     <div class="row my-4 my-md-5">
           <div class="col-12 col-md-4 col-lg-3">
               ...
               <li><a href="AllProductsBefore.php" >All Category</a></li>
               ...
               <?php
                                        ...
                                        while($row=mysqli_fetch_assoc($c))
                                        {
                                            ?>
                                                ...
                                                <li><a href="AllProductsBefore.php?CNo=<?php echo $row['CategoryNo'];?>" id='<?php echo $row['CategoryNo'];?>' ><?php echo $row['CategoryName'];?></a></li>
                                    <?php } ?>
               </ul>
