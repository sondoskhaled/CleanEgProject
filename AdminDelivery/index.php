...
<body>    
            ...
            <div class="mb-5 mt-5 font-40 font-weight-bold text-center" style="height:50px;Padding-top:50px;">Pending Order</div>
                    ...
                    <?php } ?>
                        ...
                        <div id="map_canvas<?php echo $rows['OrderNo']; ?>" style="height: 450px;width: 90%;margin: 0.6em;"></div>
                                    ...
                                    <div class="modal-footer"> 
                                        ...
                                        <!-- <a href="UpdateStatus.php?ONo=<?php //echo $rows['OrderNo']; ?>"  class="btn btn-secondary ">Shipping</a> -->
                                       <a href="index.php"> <button type="button" class="btn btn-secondary shipping" id="<?php echo $rows['OrderNo']; ?>" >Start Shipping</button></a>
                                        <script>
                                            // $(function(){
                                            //     console.log( OrderNoVal+$('.shipping').attr('id')=<?php echo $rows['OrderNo']; ?>);
                                            // });
  ...
  <script>
    ...
    $(document).ready(function(){
        ...
        $(".shipping").click(function(){
            ...
            console.log('Start');
            ONo=$(this).attr('id');
            var myVar = setInterval(sendLocation, 5000);
        ...
        function sendLocation(){
            ...
            console.log(ONo);   
        $.ajax({
          url: "CurrentLocation.php",
          method: "POST",
          data: {l:l ,g:g,c:c,ONo:ONo}
        }).done(function(d) {
          console.log(d);
            //gov = JSON.parse(city);
