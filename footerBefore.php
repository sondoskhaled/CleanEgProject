...
<div class="fables-footer-image fables-after-overlay white-color py-5 bg-rules">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                ...
                <ul class="nav fables-footer-links">
                    ...
                    <li><a href="AllProductsBefore.php">Products</a></li>
...
<div class="copyright fables-main-background-color mt-0 border-0 white-color">
        ...
        <p class="mb-0">Copyright © Egclean 2019. All rights reserved.</p> 
