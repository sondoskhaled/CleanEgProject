        ...
        <div class="row overflow-hidden mb-lg-5">
            <div class="col-12 col-sm-6 col-lg-3 text-center mb-4 mb-lg-0 wow bounceInDown" data-wow-duration="2s" data-wow-delay=".4s">
                <div class="table-block table-border-light py-5 fables-second-hover-border">
                    ...
                    <a href="#modalCart" data-toggle="modal" data-target="#modalCart" class="btn fables-second-background-color white-color white-color-hover fables-btn-rounded px-5 py-2  btn-bg-hover ">
        ...
        <div class="container">
            <div class="row">
                <div class="position-relative z-index col-12 col-md-8 offset-md-2 text-center wow zoomIn" data-wow-duration="2s">
                    ...
                    <a href="#modalCart" data-toggle="modal" data-target="#modalCart" class="btn fables-second-background-color white-color white-color-hover fables-btn-rounded  mt-4 py-2 px-5">Make a Request Now</a>
                </div>
            </div>
        ...
        <div class="container z-index position-relative overflow-hidden">
            <div class="row">
                ...
                <div class="col-12 col-md-5 col-lg-3 text-right offset-lg-2 my-4 my-md-0 mt-md-5 mt-lg-0 text-center">
                    <a href="AllProductsAfter.php" class="btn fables-second-background-color white-color white-color-hover fables-btn-rounded px-5 py-2">View all products</a>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body col-12">
                                ...
                                <p class="fables-product-info">
                                    <a href="AddToCart.php?PNo=<?php echo ($rs['ProductNo']); ?>&QYT=1&Color=<?php echo ($rs['ColorNo']); ?>" class="btn fables-second-border-color fables-second-text-color fables-btn-rouned fables-hover-btn-color font-14 px-4 py-2">
